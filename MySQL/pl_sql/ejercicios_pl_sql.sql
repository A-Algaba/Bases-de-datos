...
-- Crea un procedimiento que reciba como par谩metro la matr铆cula de un coche vendido. El procedimiento debe mostrar por pantalla el nombre del cliente que 
-- compr贸 el coche, el nombre del empleado que realiz贸 la venta, el precio de venta (debe manejar  NO_DATA_FOUND).
...
-- funcion
-- Funci贸n que devuelve el nombre de un cliente, pasa el dni por par谩metro. (en caso de NO_DATA_FOUND lanzar excepci贸n)
...
-- Funci髇 que devuelve el n鷐ero de coches vendidos por un empleado
...
-- Ejercicio 1
-- Crea una funci贸n que reciba la matr铆cula de un coche y devuelva su precio de compra.
...
-- Ejercicio 2 
-- Crea un procedimiento que reciba el DNI de un cliente y muestre por consola su nombre y tel茅fono.
...
-- Ejercicio 4
-- Crea un procedimiento que reciba una forma de pago y muestre cu谩ntas ventas se han realizado con esa forma de pago.
...
-- Ejercicio 5
-- Crea un trigger que impida realizar una venta si el coche con esa matr铆cula ya ha sido vendido anteriormente.
